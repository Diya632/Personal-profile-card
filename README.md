...
<body>
    <header>
        <img src="https://avatars.githubusercontent.com/u/138640084?v=4" alt="Diya, a smiling young woman with wavy hair wearing professional attire" class="profile-image floating">
        <h1>Diya Shrestha</h1>
    ...
    <main class="container">
        <section id="about">
            ...
            <div class="about-content">
                <div class="about-text">
                    ...
                    <p> I am a young energetic girl currently studying at last year.With all the years of these educational institutions ,I 
                        learnt to boost my self confidence and interpersonal skills. This is my personal profile I have created with skills.
                    </p>
                    
                    <h3 style= "margin-top:1.5rhm">Skills and Expertise</h3></span>
            ...
            <h4 style="margin-top:1.5rhm">Education</h4></span>
        <div class="Education">

        
        <span class="Education"> Holy Vision Hihger Secondary School , SEE</span>
        <span class="Education"> Rosebud School, SLCE</span>
        <span class="Education"> Nepal Mega College , BCA</span>
            ...
            <h5 style="margin-top:1.5rhm">Hobbies</h5></span>
            <div class ="Hobbies">
                <span class="Hobbies">Reading Books</span>
                <span class="Hobbies">Listening Music</span>
                <span class="Hobbies">travelling</span>
            </div>
        </section>
